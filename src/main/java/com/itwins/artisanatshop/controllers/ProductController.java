...
//import ma.ac.emi.ginfo.responses.ProductResponse;
...
public class ProductController {
    ...
    // This methode is used in Client app to get product by Category Id 
    @CrossOrigin()
    @GetMapping("/productByCategory/{idCat}")
    public List<Product> showProductsByIdCat(@PathVariable String idCat) {
        int categoryId = Integer.parseInt(idCat);
